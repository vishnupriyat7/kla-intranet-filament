        ...
        <div class="container px-0">
            <div class="topbar-top d-flex justify-content-between flex-lg-wrap">
                <div class="top-info flex-grow-0">
                    <span> <img src="{{ asset('storage/img/Government_of_Kerala_Logo.png') }}" class="img-fluid me-2"
                            style="width: 30px; height: 30px;" alt="Government of Kerala Logo">
                    </span>
                ...
                <div class="collapse navbar-collapse py-3" id="navbarCollapse">
                    <div class="navbar-nav mx-auto border-top">
                        ...
                        {{-- <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    <a class="dropdown-item"
                                        href="http://192.168.11.12/data/Resetting 20of 20NIC 20eMail 20Password_KLS.pdf/"
                        ...
                        <a href="http://172.24.18.28/attendance-mgmt-backend/booking_tv" class="nav-item nav-link"
                            target="_blank">Today's Meetings</a>
